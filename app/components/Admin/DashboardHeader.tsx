...
const DashboardHeader: FC<Props> = ({ open, setOpen }) => {
    ...
    return (
        <div className="w-80 flex items-center justify-end p-6 fixed top-5 right-0 z-[99999999]">
            <ThemeSwitcher />
            <div
                className="relative cursor-pointer m-2" onClick={() => setOpen(!open)}>
            ...
            {open && (
                <div className="w-[350px] h-[50vh] dark:bg-[#111C43] bg-white shadow-xl absolute top-16 z-[999999] rounded">
