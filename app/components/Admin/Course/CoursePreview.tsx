...
const CoursePreview: FC<Props> = ({
    ...
    const dicountPercentenge = ((courseData?.estimatedPrice - courseData?.price) /
    ...
    return (
        <div className="w-[90%] m-auto py-5 mb-5">
            <div className="w-full relative">
                ...
                <div className="flex items-center">
                    <div
                        className={`${styles.button} !w-[180px] my-3 font-Poppins !bg-[crimson] cursor-not-allowed dark:text-white`}>
                ...
                <div className="flex items-center">
                    ...
                    />
                    <div
                        className={`${styles.button} !w-[120px] my-3ml-4 font-Poppins cursor-pointer dark:text-white`}
                    >
                        Apply
                    </div>
                </div>
                ...
                <p className="pb-3 800px:pb-1 dark:text-white">• Premium Supports</p>
            </div>
            <div className="w-full">
                <div className="w-full 800px:pr-5">
                    ...
                    <div className="flex items-center justify-between pt-3 dark:text-white">
                        <div className="flex items-center ">
                            <Ratings rating={0} />
                            <h5>0 Reviews</h5>
                        </div>
