...
const AllCourses = (props: Props) => {
    ...
    const columns = [
        ...
        { field: "created _at", headerName: "Created At", flex: 0.5 },
        {
                ...
                isLoading ? (
                    ...
                    <Box m="20px 10px 10px 50px">
                        <Box
                            ...
                            sx={{
                                ...
                                "& .MuiDataGrid-virtualScroller": {
                                    backgroundColor: theme === "dark" ? "#1F2A40" : "#F2FOFO",
                                },
                        ...
                        <Modal
                            ...
                            <Box className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-[450px] bg-white dark:bg-slate-900 rounded-[8x] shadow p-4 outline-none">
