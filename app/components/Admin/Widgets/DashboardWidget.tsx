...
import OrdersAnalytics from '../Analytics/OrdersAnayltics';
import AllInvoices from '../Order/AllInvoice';
    ...
    return (
        <div className="mt-[30px] min-h-screen">
            ...
            <div className="grid grid-cols-[65%,35%] mt-[-20px]">
                <div className="dark:bg-[#111c43] w-[90%] mt-[30px] mr-[37px] h-[40vh] shadow-sm m-auto">
