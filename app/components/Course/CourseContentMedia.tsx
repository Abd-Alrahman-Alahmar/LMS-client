...
import ViemoPlayer from '../../../app/utils/ViemoPlayer';
...
const CourseContentMedia = ({ data, id, activeVideo, setActiveVideo, user, refetch }: Props) => {
    ...
    const handleAnswerSubmit = () => {
        addAnswerInQuestion({ answer, courseld: id, contentId: data[activeVideo]._id, questionId: questionId })
    }
    ...
    return (
        <div className="w-[95%] 800px:w- [86%] py-4 m-auto">
            ...
            <h1 className="dark:text-white text-black pt-2 text-[25px] font-[600]">{data[activeVideo].title}</h1>
            <br />
                    ...
                    <div className="w-full flex justify-end">
                        <div
                            className={`${styles.button
                                } !w-[120px] !h-[40px] text-[18px] mt-5 dark:text-white text-black ${questionCreationLoading && 'cursor-not-allowed'}`}
                        ...
                        <>
                            {
                                !isReviewExists && (
                                    <>
                                        ...
                                        <div className="w-full flex justify-end">
                                            <div
                                                className={`${styles.button} !w-[120px] !h-[40px] text-[18px] mt-5 800px:mr-0 mr-2 dark:text-white text-black ${reviewCreationLoading && 'cursor-no-drop'}`}
                                            ...
                                            {isReviewReply && reviewId === item._id && (
                                                <div className="w-full flex relative">
                                                    <input
                                                        ...
                                                        className="block 800px:ml-12 mt-2 outline-none bg-transparent border-b border-[#000] dark:border-[#fff] p-[5px] w-[95%] dark:text-white text-black"
                                                    />
                                                    <button
                                                        type="submit"
...
const CommentItem = ({
    data, questionId,setQuestionId, item, answer, setAnswer, handleAnswerSubmit, answerCreationLoading
}: any) => {
                ...
                <div className="flex mb-2">
                    <div>
                        <Image
                            ...
                            height={50}
                            alt=""
                            className="w-[50px] h-[50px] rounded-full obiect-cover"
                        />
                    </div>
                    <div className="pl-3 dark:text-white text-black">
                        ...
                        <small className="text-[#000000b8] dark:text-[#ffffff83]">
                            {!item.createdAt ? "" : format(item?.createdAt)} •</ small>
                    </div>
                </div>
                <div className="w-full flex">
                    <span className="800px:pl-16 text-[#000000b8] dark:text-[#ffffff83] cursor-pointer mr-2"
                        onClick={() => {
