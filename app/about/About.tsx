        ...
        <div className="text-black dark:text-white mt-14">
            ...
            <div className="w-[95%] 800px:w-[85%] m-auto">
                <p className="text-[18px] font-Poppins">
                    ...
                    That&apos;s why I created ELearning &ndash; to provide new programmers with the
                    resources and support they need to succeed.
                    <br />
                    <br />
                    At ELearning, we believe that price should never be a barrier to
                    achieving your dreams. That&apos;s why our courses are priced low I so that
                    anyone, regardless of their financial situation, can access the tools
                    and knowledge they need to succeed.
                    <br />
                    <br />
                    But ELearning is more than just a community &ndash; we&apos;re a family. Our
                    ...
                    take vour skills to the next level.
                    <br />
                    <br />
                ...
                <br />
                <span className="text-[22px]">Rahman-</span>
